...
public class DialogUtil {
    ...
    public DialogUtil(Context context) {
        ...
        // 对话框布局
        RelativeLayout dialogRLayout = (RelativeLayout) dialog.findViewById(R.id.rl_dialog);
        ViewUtil.setViewSize(dialogRLayout, 360, 540);
    ...
    public void setTitle(int icon) {
        titleImgView.setVisibility(icon > 0 ? View.GONE : View.VISIBLE);
